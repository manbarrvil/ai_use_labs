** SMARTIE 3 TERMINALES CON Pï¿½RDIDAS -- MAX_GEN
*********
...
SCALAR Vmax   Tensiï¿½n mï¿½xima en cada nudo
       Vmin   Tensiï¿½n mï¿½nima en cada nudo
       V_SUBEST   tensiï¿½n en barras de la SE
...
PARAMETER
          ...
          COS_PHI
*          r_link_pmin(n,n)   Mï¿½nimo flujo de p activa en link de continua (flujo inverso)
*          r_link_pmax(n,n)   Mï¿½ximo flujo de p activa en link de continua
*          r_link_smax        Mï¿½ximo flujo de p aparente en link de continua
          ;
FdG=1;
P(ND) = DATNUD(ND,'P')*1;
Q(ND) = DATNUD(ND,'Q')*1;
...
EQUATION     smax_n  mï¿½xima potencia aparente de cada convertidor  ;
