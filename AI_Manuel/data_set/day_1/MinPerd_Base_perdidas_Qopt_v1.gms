...
PSE = Pgen.l('GF0') * SBASE *1000 ;
QSE = Qgen.l('GF0') * SBASE *1000 ;
G_INI(NG) = Pgen2.l(NG) * SBASE *1000  ;
G_FIN(NG) = Pgen2.l(NG) * LambdaG.l(NG) * SBASE *1000 ;
G_DIF(NG) = G_FIN(NG) - G_INI(NG) ;
QGEN_2(NG)=  Qgen2.l(NG) * SBASE *1000 ;
PGEN_2(NG)=  Pgen2.l(NG) * SBASE *1000 * LambdaG.l(NG) ;
PLOAD(ND) = Lambda.l*P(ND)* SBASE *1000;
QLOAD(ND) = Lambda.l*Q(ND)* SBASE *1000;
